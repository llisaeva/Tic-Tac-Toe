...
## Game Window
The game starts in Player vs Player mode. The top corners show the names and scores for Player X and Player O. 
You can change the color themes by clicking on the swatches on the bottom left corner. 
...
- __Master vs Master__ – watch to bots play.
